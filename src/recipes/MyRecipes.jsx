...
import { searchrecipe, getRecipesByUser} from "../api/getrecipes";
  ...
  return (
    <>
      <div className="createresipes">
        <button
          type="button"
          className="creatresipesbtn shadow"
          onClick={buttonClick}
        >
      ...
      <section className="margintops">
        <div className="container">
          <div className="col-md-10 mx-auto">
            <Title titleone="My Recipes" titletwo="Create your recipes" />

            <div className="d-flex justify-content-center mb-5">
              <input
                type="text"
                name="title"
                className="form-control-sm navsearchs py-3"
                value={find}
